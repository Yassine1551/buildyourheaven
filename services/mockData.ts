...
export const dhikrItems: DhikrItem[] = [
  ...
  },
  {
    ...
    source: 'رواه مسلم',
    unlockRequirement: 'أكمل "مغفرة الذنوب"\n10 مرات',
    order: 2,
  },
  {
    id: 'nakhla',
    ...
    unlockRequirement: 'أكمل "ألف حسنة"\n3 مرات',
    order: 3,
  },
  {
    id: 'hirz',
    ...
    source: 'متفق عليه',
    unlockRequirement: 'أكمل "كفاية الهم"\n500 مرة',
    order: 15,
  },
  {
    id: 'salat-nabi',
    ...
    unlockRequirement: 'أكمل "حط الخطايا"\nمرة واحدة',
    order: 5,
  },
  {
    id: 'thuluth-quran',
    ...
    fadl: 'إنها تعدِلُ ثلثَ القرآن، وثلاثُ مراتٍ منها تعدِلُ ختمةً كاملة',
    targetCount: 3,
    icon: 'menu-book',
    color: '#8B5CF6',
    hasanatPerCount: 470,
    ...
    source: 'متفق عليه',
    unlockRequirement: 'أكمل "الصلاة على النبي"\n200 مرة',
    order: 6,
  },
  {
    id: 'kanz',
    ...
    source: 'متفق عليه',
    unlockRequirement: 'أكمل "ثلث القرآن"\n100 مرة',
    order: 7,
  },
  {
    id: 'sadaqat-dhikr',
    ...
    source: 'رواه مسلم',
    unlockRequirement: 'أكمل "قصر في الجنة"\n100 مرة',
    order: 10,
  },
  {
    id: 'milul-mizan',
    ...
    source: 'رواه مسلم',
    unlockRequirement: 'أكمل "حرز من الشيطان"\nمرة واحدة',
    order: 16,
  },
  {
    id: 'jawamie',
    ...
    source: 'رواه مسلم',
    unlockRequirement: 'أكمل "عتق الرقاب"\n100 مرة',
    order: 12,
  },
  {
    id: 'dhikr_qasr',
    ...
    unlockRequirement: 'أكمل "كنز الجنة"\n200 مرة',
    order: 8,
  },
  {
    id: 'jawahir',
    ...
    unlockRequirement: 'أكمل "جوامع الكلم"\n33 مرة',
    order: 13,
  },
  {
    id: 'hatt-khataya',
    ...
    source: 'متفق عليه',
    unlockRequirement: 'أكمل "نخلة في الجنة"\n200 مرة',
    order: 4,
  },
  {
    id: 'hasbiyallah',
    title: 'كفاية الهم',
    dhikrText: 'حَسْبِيَ اللَّهُ لَا إِلَهَ إِلَّا هُوَ عَلَيْهِ تَوَكَّلْتُ وَهُوَ رَبُّ الْعَرْشِ الْعَظِيمِ',
    fadl: 'مَن قالها حين يصبح وحين يمسي سبع مرات كفاه الله ما أهمه من أمر الدنيا والآخرة',
    targetCount: 7,
    icon: 'security',
    color: '#0D9488',
    hasanatPerCount: 10,
    isShield: true,
    extraLifeMinutes: 5,
    daleel: 'عن أسماء بنت عميس رضي الله عنها أن النبي ﷺ قال: «مَن قالها حين يصبح وحين يمسي سبع مرات: حسبي الله لا إله إلا هو عليه توكلت وهو رب العرش العظيم، كفاه الله ما أهمه من أمر الدنيا والآخرة»',
    source: 'رواه أبو داود — حسّنه الألباني',
    unlockRequirement: 'أكمل "جوهرة الأذكار"\n10 مرات',
    order: 14,
  },
  {
    id: 'tahlil',
    title: 'عتق الرقاب',
    dhikrText: 'لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ، وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ',
    fadl: 'مَن قالها عشر مرات كان كمن أعتق أربعة أنفس من ولد إسماعيل',
    targetCount: 10,
    icon: 'people',
    color: '#6366F1',
    hasanatPerCount: 10,
    slavesFreed: 4,
    daleel: 'عن أبي هريرة رضي الله عنه أن النبي ﷺ قال: «مَن قال: لا إله إلا الله وحده لا شريك له، له الملك وله الحمد وهو على كل شيء قدير، عشر مرات، كان كمن أعتق أربعة أنفس من ولد إسماعيل»',
    source: 'متفق عليه',
    unlockRequirement: 'أكمل "صدقات الأذكار"\n300 مرة',
    order: 11,
  },
];
